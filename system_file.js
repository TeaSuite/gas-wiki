/*
 * @brief みんなデータベースにアクセスするのでシングルトンにキャッシュしておく
 *
 *
 */
function DatabaseManager()
{
    ...
    DatabaseManager = function DatabaseManager() {
        return instance;
    };

    DatabaseManager.prototype = this;
    instance = new DatabaseManager();
    instance.constructor = DatabaseManager;

    instance.database = DriveApp.getFolderById(PropertiesService.getScriptProperties().getProperty("DATABASE_ID"));
